...
/datum/DBColumn/New(name_handler, table_handler, position_handler, type_handler, flag_handler, length_char_handler, max_length_char_handler)
	name = name_handler
	table = table_handler
	position = position_handler
	sql_type = type_handler
	flags = flag_handler
	length_char = length_char_handler
	max_length_char = max_length_char_handler
