...
"}
	...
	user << browse("<HEAD><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><TITLE>Robotic Fabricator Control Panel</TITLE></HEAD><TT>[dat]</TT>", "window=robot_fabricator")
