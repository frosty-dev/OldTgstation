...
/datum/admins/Topic(href, href_list)
	...
	/////////////////////////////////////new ban stuff
		...
		var/dat = "<head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><title>Job-Ban Panel: [key_name(M)]</title></head>"
...
//Regular jobs
	//Command (Blue)
		...
		dat += "<tr align='center' bgcolor='ccccff'><th colspan='[length_char(GLOB.command_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=commanddept;jobban4=\ref[M]'>Command Positions</a></th></tr><tr align='center'>"
	...
	//Security (Red)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='ffddf0'><th colspan='[length_char(GLOB.security_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=securitydept;jobban4=\ref[M]'>Security Positions</a></th></tr><tr align='center'>"
	...
	//Engineering (Yellow)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='fff5cc'><th colspan='[length_char(GLOB.engineering_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=engineeringdept;jobban4=\ref[M]'>Engineering Positions</a></th></tr><tr align='center'>"
	...
	//Medical (White)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='ffeef0'><th colspan='[length_char(GLOB.medical_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=medicaldept;jobban4=\ref[M]'>Medical Positions</a></th></tr><tr align='center'>"
	...
	//Science (Purple)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='e79fff'><th colspan='[length_char(GLOB.science_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=sciencedept;jobban4=\ref[M]'>Science Positions</a></th></tr><tr align='center'>"
	...
	//Supply (Brown)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='DDAA55'><th colspan='[length_char(GLOB.supply_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=supplydept;jobban4=\ref[M]'>Supply Positions</a></th></tr><tr align='center'>"
	...
	//Civilian (Grey)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='dddddd'><th colspan='[length_char(GLOB.civilian_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=civiliandept;jobban4=\ref[M]'>Civilian Positions</a></th></tr><tr align='center'>"
	...
	//Non-Human (Green)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='ccffcc'><th colspan='[length_char(GLOB.nonhuman_positions)]'><a href='?src=\ref[src];[HrefToken()];jobban3=nonhumandept;jobban4=\ref[M]'>Non-human Positions</a></th></tr><tr align='center'>"
	...
	//JOBBAN'S INNARDS
		...
		while (findtext_char(src.admincaster_feed_channel.channel_name," ") == 1)
			src.admincaster_feed_channel.channel_name = copytext_char(src.admincaster_feed_channel.channel_name,2,length_char(src.admincaster_feed_channel.channel_name)+1)
		src.access_news_network()
		...
		while (findtext_char(src.admincaster_feed_message.returnBody(-1)," ") == 1)
			src.admincaster_feed_message.body = copytext_char(src.admincaster_feed_message.returnBody(-1),2,length_char(src.admincaster_feed_message.returnBody(-1))+1)
		src.access_news_network()
		...
		while(findtext_char(src.admincaster_wanted_message.criminal," ") == 1)
			src.admincaster_wanted_message.criminal = copytext_char(admincaster_wanted_message.criminal,2,length_char(admincaster_wanted_message.criminal)+1)
		src.access_news_network()
		...
		while (findtext_char(src.admincaster_wanted_message.body," ") == 1)
			src.admincaster_wanted_message.body = copytext_char(src.admincaster_wanted_message.body,2,length_char(src.admincaster_wanted_message.body)+1)
		src.access_news_network()
