...
Finds the number of days since the day in 2000 and gets the modulo of that and the average length_char of a Muslim year since the first one (622 AD, Gregorian)
