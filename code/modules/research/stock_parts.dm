...
/obj/item/stock_parts/subspace/analyzer
	name = "subspace wavelength_char analyzer"
	icon_state = "wavelength_char_analyzer"
	desc = "A sophisticated analyzer capable of analyzing cryptic subspace wavelength_chars."
	origin_tech = "programming=2;magnets=2;materials=2;bluespace=2"
	materials = list(MAT_METAL=30, MAT_GLASS=10)
